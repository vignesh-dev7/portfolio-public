  ...
  return (
    <section>
      ...
      >
        <Box
          sx={{
            // CHANGED: Increased maxWidth to 'xl' to fill available width on large screens
            maxWidth: "xl", 
            margin: "0 auto",
            width: "95%",
            px: { xs: 2, sm: 3, md: 4 },
        ...
        >
          <Grid container spacing={4} alignItems="center" justifyContent="center" sx={{ ...isSmallScreen && {width: "100vw"}}}>
            {/* CHANGED: Removed 'md={11} lg={10}' restriction so it takes full width */}
            <Grid item xs={12} sx={{ textAlign: "center" }}>
                  ...
                  {experience && (
                    <Grid item xs={12} sm={4}>
                      ...
                      >
                        ...
                        >
                          <CardContent>
                            <Stack direction="row" spacing={1} alignItems="center" mb={1} justifyContent="center">
                              <CalendarTodayIcon 
                                sx={{ 
                                  color: theme.palette.primary.main,
                                  fontSize: 24
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  ...
                  <Stack spacing={3} sx={{ position: 'relative', zIndex: 1 }}>
                    <Stack direction="row" spacing={2.5} alignItems="center" justifyContent="center" flexWrap="wrap">
                      <Box
                        sx={{
                          p: 2,
                          borderRadius: 2,
              ...
              {((experiences && experiences?.length > 0) || (education && education?.length > 0)) && (
                <>
                  ...
                  <Box sx={{ position: 'relative', pl: { xs: 2, md: 6 }, pb: 4, textAlign: "left" }}>
                    {/* Timeline Line */}
                    <Box
                      sx={{
                        position: 'absolute',
