...
function App() {
  ...
  const sidebarOffset = isSmallScreen ? 0 : SIDEBAR_WIDTH;
  ...
  return (
      <Box
        sx={{
          ...
          height: "100%",
          minHeight: "100vh",
          overflowX: "hidden",      // <-- force hide extra width
      ...
      >
        ...
        <Box
          sx={{
            flexGrow: 1,
            ml: `${sidebarOffset}px`,   // ✅ FIX for mobile/tablet
        ...
        >
          ...
          <Box
            sx={{
              position: "fixed",
              left: sidebarOffset,      // ✅ FIX for mobile/tablet
              right: 0,
              height: 61,
              zIndex: 1000,
              background: headerBg,
